          ...
          <div className="d-flex flex-column justify-content-center align-items-center h-100">
              <ul className="nav justify-content-center">
                  <li className="nav-item">
                      <a className="nav-link link-light" href="#develop" target="_blank" rel="noreferrer"> LinkedIn </a>
                  </li>
                  <li className="nav-item">
                      <a className="nav-link link-light" href="https://github.com/Noctturne" target="_blank" rel="noreferrer"> Github </a>
                  </li>
              </ul>
